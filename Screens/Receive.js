    ...
    return (
        <ScrollView contentContainerStyle={myStyle.container}>
           <StatusBar backgroundColor={'#FFFFFF'} barStyle='dark-content'/>
            <Text style={myStyle.head}>Received</Text>
            <View style={myStyle.smallCard}>
                <Text style={{ fontSize: 16, fontFamily: 'Poppins-Regular' }}>Total Receive</Text>
                <Text style={{ fontSize: 32, color: '#1D8136', fontFamily: 'Poppins-SemiBold' }}>₹ 50,1250</Text>
            </View>
            <FormSearch2 placeholderText={'Search Name'} />
            <InvoiceCard color={'#1D8136'} time={'06:30 PM'} name='Sudip Das' date={'09 Sept 2022'} mode={'bank'}/> 
            <InvoiceCard color={'#1D8136'} time={'06:30 PM'} name='Sudip Das' date={'09 Sept 2022'} mode={'cash'}/> 
            <InvoiceCard color={'#1D8136'} time={'06:30 PM'} name='Sudip Das' date={'09 Sept 2022'} mode={'bank'}/> 
            <InvoiceCard color={'#1D8136'} time={'06:30 PM'} name='Sudip Das' date={'09 Sept 2022'} mode={'cash'}/> 
        </ScrollView>
    )
